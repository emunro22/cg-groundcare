...
export const services: ServiceItem[] = [
  ...
  },
  {
    ...
    longDesc: 'From a full garden redesign to a single feature upgrade, our landscaping service covers everything needed to transform an outdoor space, including decking, artificial grass, decorative gravel, bark and planting, all finished to a high standard.',
